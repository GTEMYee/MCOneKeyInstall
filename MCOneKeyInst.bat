...
echo 若没有代理,则使用 Steam++ 进行 GitHub 加速,但不能与代理的速度相比
...
:Setproxy
echo. & echo 如果你拥有代理,在下方写下代理服务器的地址,用于为 GitHub 下载增速 & echo 由于未测试过socks代理协议,当前版本暂时只能填入 http 代理 & echo 注意带不带协议均可,例如 10.15.1.12:7890 & echo 若没有则回车键跳过,不影响下载
